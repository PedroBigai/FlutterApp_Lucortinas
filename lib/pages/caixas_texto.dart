                     ...
                     children: [
                      ...
                      if (_data.listaacessorios.isNotEmpty)
                       ...
                       ElevatedButton(
                         onPressed: () {
                           setState(() {
                             _data.containerVisible = false; // Fecha o container
                           });
                         },
                         style: ElevatedButton.styleFrom(
...
class Data {
  ...
  double precoVista = 0;
  double precoPrazo = 0;
  double precoVistaAcessorio = 0;
  double precoPrazoSalvoAcessorio = 0;
  double valortotalacessorio_vista = 0;
  double valortotalacessorio_prazo = 0;
  String acessorioSelecionado = '';
  List<Widget> listaacessorios = [];
  List<Widget> listaacessorios_adicionados = [];
  bool containerVisible = false;
  List<dynamic> precototaldeacessoriosvista = [];
  List<dynamic> precototaldeacessoriosprazo = [];
  double valorfinalvistaAcessorio = 0;
  double valorfinalprazoAcessorio = 0;
}
